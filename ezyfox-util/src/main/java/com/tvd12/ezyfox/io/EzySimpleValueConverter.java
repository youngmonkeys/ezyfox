...
public class EzySimpleValueConverter
    ...
    protected IllegalArgumentException newTransformerException(
        Class<?> type,
        Object value
    ) {
    ...
    protected void addWrapperTransformers(Map<Class, EzyToObject> answer) {
        ...
        answer.put(String.class, (EzyToObject<Object>) Object::toString);
    }

    @SuppressWarnings("MethodLength")
    protected void addPrimitiveArrayTransformers(
        Map<Class, EzyToObject> answer
    ) {
        answer.put(boolean[].class, (EzyToObject<Object>) value -> {
            if (value instanceof String) {
    ...
    @SuppressWarnings("MethodLength")
    protected void addWrapperArrayTransformers(
        Map<Class, EzyToObject> answer
    ) {
        answer.put(Boolean[].class, (EzyToObject<Object>) value -> {
            if (value instanceof String) {
    ...
    protected void addOtherTransformers(Map<Class, EzyToObject> answer) {
        answer.put(Date.class, (EzyToObject<String>) value -> {
            try {
        ...
        answer.put(LocalDate.class, (EzyToObject<String>) value -> {
            try {
        ...
        answer.put(LocalDateTime.class, (EzyToObject<String>) value -> {
            try {
    ...
    @SuppressWarnings("MethodLength")
    protected void addTwoDimensionsPrimitiveArrayTransformers(
        Map<Class, EzyToObject> answer
    ) {
        answer.put(boolean[][].class, (EzyToObject<Object>) value -> {
            if (value instanceof String) {
    ...
    @SuppressWarnings("MethodLength")
    protected void addTwoDimensionsWrapperArrayTransformers(
        Map<Class, EzyToObject> answer
    ) {
        answer.put(Boolean[][].class, (EzyToObject<Object>) value -> {
            if (value instanceof String) {
