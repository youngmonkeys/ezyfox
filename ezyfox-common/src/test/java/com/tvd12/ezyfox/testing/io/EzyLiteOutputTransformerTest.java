...
public class EzyLiteOutputTransformerTest extends EzyEntityTest {
    ...
    private final EzyOutputTransformer transformer =
        EzySingletonOutputTransformer.getInstance();
    ...
    public void test1() {
        ...
        assertEquals(transform(1L, float.class), 1F);
        assertEquals(transform(1L, int.class), 1);
        ...
        assertEquals(transform(1L, Double.class), 1D);
        assertEquals(transform(1L, Float.class), 1F);
        assertEquals(transform(1L, Integer.class), 1);
        assertEquals(transform((byte) 1, Long.class), 1L);
        assertEquals(transform(1L, Short.class), (short) 1);
    ...
    public void test5() {
        EzyObject obj = newObjectBuilder()
            ...
            .append("12", newArrayBuilder()
                ...
                .append(newArrayBuilder().append(7, 8, 9)))
            .append("13", newArrayBuilder()
                .append(newArrayBuilder().append(1D, 2D, 3D))
                .append(newArrayBuilder().append(4D, 5D, 6D))
                .append(newArrayBuilder().append(7D, 8D, 9d)))
            .append("14", newArrayBuilder()
                .append(newArrayBuilder().append(1F, 2F, 3F))
                .append(newArrayBuilder().append(4F, 5F, 6F))
                .append(newArrayBuilder().append(7F, 8F, 9F)))
            .append("15", newArrayBuilder()
                .append(newArrayBuilder().append(1, 2, 3))
                .append(newArrayBuilder().append(4, 5, 6))
                .append(newArrayBuilder().append(7, 8, 9)))
            .append("16", newArrayBuilder()
                .append(newArrayBuilder().append(1L, 2L, 3L))
                .append(newArrayBuilder().append(4L, 5L, 6L))
                .append(newArrayBuilder().append(7L, 8L, 9L)))
            .append("17", newArrayBuilder()
                .append(newArrayBuilder().append(1, 2, 3))
                .append(newArrayBuilder().append(4, 5, 6))
                .append(newArrayBuilder().append(7, 8, 9)))
