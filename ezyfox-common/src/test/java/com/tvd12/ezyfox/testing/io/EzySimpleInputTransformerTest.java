...
public class EzySimpleInputTransformerTest extends EzyEntityTest {
    ...
    private final EzyInputTransformer transformer = new EzySimpleInputTransformer();
    ...
    public void test() {
        ...
        assertEquals(transform(LocalDate.of(2017, 5, 30)), "2017-05-30");

        assertEquals(transform(LocalDateTime.of(2017, 5, 30, 12, 34, 56, 78)), "2017-05-30T12:34:56:000");
