...
public class FullTest {
    ...
    public void test1() {
        ...
        EzyBindingContext bindingContext = EzyBindingContext.builder()
            ...
            .scan((Iterable<String>) Collections.<String>emptyList())
            .scan(() -> Lists.newArrayList("com.tvd12.ezyfox.binding.testing.full").iterator())
            .build();
        EzyMarshaller marshaller = bindingContext.newMarshaller();
        EzyUnmarshaller unmarshaller = bindingContext.newUnmarshaller();
        EzyObject object = marshaller.marshal(fullData);
        ...
        assertNull(marshaller.marshal(null, (Object) null));
...
//        Tiny tiny = new EzyObjectInstanceRandom().randomObject(Tiny.class, false);
        ...
        assertNull(unmarshaller.unmarshal(null, (Object) null));
